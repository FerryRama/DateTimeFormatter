...
public class Main {
    public static void main(String[] args) throws ParseException {
        //String dates = "05-02-2023 16.51.48,430314000";
        //Instant instant = Instant.parse("2018-01-01T19:34:50.63Z");
/*        Instant instant = Instant.parse("2018-01-01T19:34:50.63Z");
        Instant values = instant.plus(14, ChronoUnit.DAYS);
        System.out.println("Instant after adding 30 DAYS: " + values);*/


        //System.out.println("Instant DAYS: " + Instant.now());
        ...
        String startDateString = "12-02-2023 14.20.02,197553000";
